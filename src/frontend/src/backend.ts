...
export class Backend implements backendInterface {
    ...
    async getFeaturedDeals(): Promise<Array<ProductDeal>> {
        if (this.processError) {
            try {
    ...
    async getItemCount(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getItemCount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalItemCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalItemCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeItemFromCart(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
